...
var collectionSchema = mongoose.Schema({
  collection_id: {
    ...
    unique: [
      true,
      "Collection_id already exists. Please try a different collection_id",
    ],
  ...
  collection_keyword: {
    ...
    unique: [
      true,
      "collection_keyword already exists. Please try a different collection_keyword",
    ],
  ...
  contract_symbol: {
    ...
    unique: [
      true,
      "contract_symbol already exists. Please try a different contract_symbol",
    ],
  ...
  collection_address: {
    ...
    unique: [
      true,
      "collection_address already exists. Please try a different collection_address",
    ],
