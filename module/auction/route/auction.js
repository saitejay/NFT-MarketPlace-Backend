...
router.post('/add', [check('auction_id').not().isEmpty(), check('item_id').not().isEmpty(), check('minimum_bid_amount').not().isEmpty(), check('auction_start_time').not().isEmpty(), check('auction_end_time').not().isEmpty(), auth], auctionController.add)
